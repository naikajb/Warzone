...
//     if (toAttack().empty())
//     {
//         std::cout << "No territories to attack!" << std::endl;
//         return; // or handle the case where there are no territories to attack
//     }

//     Territory *selectedTerritoryToAttack = toAttack()[randomIndexAttack];
//     if (selectedTerritoryToAttack == nullptr)
//     {
//         std::cout << "Invalid territory selected for attack!" << std::endl;
//         return;
//     }

//     if (randomIndexAttack >= 0 && randomIndexAttack < toAttack().size())
//     {
//         Territory *selectedTerritoryToAttack = toAttack()[randomIndexAttack];
//     }
//     else
...
//         std::cout << "Invalid random index for toAttack" << std::endl;
//     }
